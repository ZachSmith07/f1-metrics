...
import TyreStrategyChart from "@/app/components/StrategyWidget";
...
export default function SessionDash() {
  ...
  // changes selection of which analysis the user is viewing
  ...
  return (
    <>
      ...
      <Box display="flex" flexDirection="column" justifyContent="center" alignItems="center" mt="20px">
        ...
        {/* displays all analysis options to seelct */}
        <ToggleButtonGroup
          value={selection}
          exclusive
