...
import { CssBaseline, ThemeProvider, Box, ToggleButtonGroup, ToggleButton } from "@mui/material";
...
// displays toggle buttons with Events and Standings
export default function Dash() {
  // defines events and standings data
  ...
  // changes selections based on search parameters
  useEffect(() => {
  ...
  // on change of selection, it sets the new selection
  ...
  return (
    <>
      ...
      <Box display="flex" flexDirection="column" justifyContent="center" alignItems="center" mt="20px">
        ...
        {/* displays whichever section is appropriate */}
        {
          selection == "events" ?
